...
namespace Intotech.Wheelo.Tests.Persistence.Seed
{
    public class SeedAccount : SeedLogic<Account>
    {
        ...
        public override void Insert()
        {
            ...
            {
                new Account() { Name = "Bartek", Surname = "Zapart", Gender = 1, Method = "wheelo", Phone = "12343256", Email = "bzapart@gmail.com", Login = "ghostrider", Password = HashGenerator.HashSHA256("beatka"), Token = "cntgfu347frgwhu293", Idrole = 2 }
            };
            ...
            for (int i = 0; i < 50; i++)
            {
                accounts.Add(new Account() { Name = Names[rnd.Next(0, Names.Count - 1)], Surname = Surnames[rnd.Next(0, Surnames.Count - 1)], Gender = i % 2 + 1, Phone = "12343256", Password = HashGenerator.HashSHA256("beatka"), Method = "wheelo", Email = StringUtils.GetRandomText(12), Login = StringUtils.GetRandomText(7), Token = StringUtils.GetRandomText(18), Idrole = 2 });
            }
