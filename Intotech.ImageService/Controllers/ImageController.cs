...
public class ImageController : Controller
{
    ...
    public ActionResult Index()
    {
        ...
        //byte[] result = Convert.FromBase64String(imageBase64);// imageBase64.Replace("data:image/jpeg;base64,", ""));
        ...
        //MemoryStream ms = new MemoryStream(Convert.FromBase64String(imageBase64.Replace("data:image/jpeg;base64,", "")));
        //StreamWriter swr = new StreamWriter(imageBase64);
